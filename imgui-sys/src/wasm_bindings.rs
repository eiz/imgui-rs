...
impl ::core::fmt::Debug for ImGuiDataTypeInfo {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        write!(
            f,
            "ImGuiDataTypeInfo {{ Name: {:?}, PrintFmt: {:?}, ScanFmt: {:?} }}",
            self.Name, self.PrintFmt, self.ScanFmt
        )
    }
}
...
pub type ImGuiKeyPrivate_ = cty::c_uint;
...
#[link(wasm_import_module = "imgui-sys-v0")]
extern "C" {
    pub fn igGetKeyIndex(key: ImGuiKey) -> cty::c_int;
}
#[link(wasm_import_module = "imgui-sys-v0")]
extern "C" {
...
#[link(wasm_import_module = "imgui-sys-v0")]
extern "C" {
    pub fn igGetNavInputName(n: ImGuiNavInput) -> *const cty::c_char;
}
#[link(wasm_import_module = "imgui-sys-v0")]
extern "C" {
